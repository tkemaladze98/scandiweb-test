              ...
              <>
                <div>
                  <button
                    ...
                    onClick={this.currencyVisibility}
                  >
                ...
                <article>
                  <button onClick={this.cartVisibility} className="cart-logo">
                    <svg
                      width="20"
                      height="14"
                      viewBox="0 0 20 14"
                    ...
                    <div className="outside">
                      <div className="mini-cart">
                              ...
                              <div className="cart-info-div">
                                <div className="price-div">
                                  ...
                                  <div className="attributes">
                                    {Object.keys(item.selectedAttributes).map(
                                      (key) => (
                                        <div>
                                          <span>
                        ...
                        <h3 className="total-price">
                          <span>Total:</span>
                          <span>{this.calculateTotalPrice(0)}</span>
                        </h3>
                        <div className="buttons">
                          <Link to="/test">VIEW BAG</Link>
